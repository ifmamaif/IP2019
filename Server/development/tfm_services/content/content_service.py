...
class ContentService:
    ...
    @view_config(route_name = 'tfm_get_stories', request_method = 'POST')
    @authorize_operation
    ...
    @view_config(route_name = 'tfm_get_chapters', request_method = 'POST')
    @authorize_operation
    ...
    @view_config(route_name = 'tfm_send_chapter_response', request_method = 'POST')
    @authorize_operation
